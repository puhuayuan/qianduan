              ...
              <div className={ShanchuCSS.A}>
                ...
                <table border="1">
                 ...
                 <tr className={ShanchuCSS.B}>
                     ...
                     <td><button onClick={this.saveUser()}>查询</button><button onClick={this.deleteUser()}>删除</button></td>
                   </tr>
                </table>
                 ...
                 <tr height="40px">
                   ...
                   <td></td>
                    ...
                    <tr className={ShanchuCSS.D}>
                      ...
                      <td><button onClick={this.query()} >添加</button><button onClick={this.deleteNews()} >删除</button></td>
                    </tr>
                </table>
                </div>
              </div>
